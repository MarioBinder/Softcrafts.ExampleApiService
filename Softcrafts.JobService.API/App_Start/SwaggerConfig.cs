...
namespace Softcrafts.JobService.API
{
    ...
    /// 
    /// </summary>
    public class AddJobSchemaExamples : ISchemaFilter
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// 
    /// </summary>
    public class RemoveJobDetailsFromSwagger : IDocumentFilter
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    public class SwaggerConfig
    {
        ...
        {
            var path = $"{AppDomain.CurrentDomain.BaseDirectory}bin\\swagger.xml";
        ...
        public static void Configure(HttpConfiguration configuration)
        {
            configuration
                .EnableSwagger(c =>
                {
                    c.SingleApiVersion("v1", Assembly.GetExecutingAssembly().GetName().Name)
                        .Description(" **MBD SEMAS Jobservice** \n "+
                                     " \n - HATEOAS DRIVEN RESTful API (Hypermedia as the engine of application state) " +
                                     " \n - Stellt Operationen bereit, Job - Eintr�ge zu registrieren, deren Status zu speichern und abzufragen.")
                        .Contact(cc => cc
                            .Name("Mario Binder - WOLFF Daten. Menschen. Marketing. GmbH")
                            .Url("https://www.wolff-dmm.de/")
                            .Email("mario.binder@wolff-dmm.de"));

                    c.PrettyPrint();
                    c.BasicAuth("basic").Description("Basic HTTP Authentication");
                    c.DescribeAllEnumsAsStrings(true);
                    c.UseFullTypeNameInSchemaIds();
                    c.SchemaFilter<AddJobSchemaExamples>();
                    c.DocumentFilter<RemoveJobDetailsFromSwagger>();
                    c.IncludeXmlComments(() => new XPathDocument(GetXmlDocumentationPath()));

#if RELEASE
                    c.RootUrl(req => GetRootPath());
#endif
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    c.DocumentTitle("SEMAS Web APIs - JobService");
                    c.InjectStylesheet(typeof(SwaggerConfig).Assembly, "Softcrafts.JobService.API.Styles.StyleSheet1.css");
                    c.InjectJavaScript(typeof(SwaggerConfig).Assembly, "Softcrafts.JobService.API.Styles.JavaScript.js");
                });
            ...
            //                  //
            //                  c.SingleApiVersion("v1", "Softcrafts.JobService.API");
